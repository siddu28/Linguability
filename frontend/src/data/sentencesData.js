...
export const sentencesData = {
    english: {
        simple_statements: [
            ...
            { id: 6, word: 'The cat is sleeping', phonetic: '/ðə kæt ɪz ˈsliːpɪŋ/', speakable: 'The cat is sleeping', translation: 'Describing an action' },
            { id: 7, word: 'I live in a house', phonetic: '/aɪ lɪv ɪn ə haʊs/', speakable: 'I live in a house', translation: 'Stating residence' },
            { id: 8, word: 'They are students', phonetic: '/ðeɪ ɑːr ˈstuːdənts/', speakable: 'They are students', translation: 'Describing occupation' },
            { id: 9, word: 'I eat breakfast every morning', phonetic: '/aɪ iːt ˈbrekfəst ˈevri ˈmɔːrnɪŋ/', speakable: 'I eat breakfast every morning', translation: 'Daily routine' },
            { id: 10, word: 'The flowers are beautiful', phonetic: '/ðə ˈflaʊərz ɑːr ˈbjuːtɪfəl/', speakable: 'The flowers are beautiful', translation: 'Describing beauty' },
        ],
        asking_questions: [
            ...
            { id: 6, word: 'Do you speak English?', phonetic: '/duː juː spiːk ˈɪŋɡlɪʃ/', speakable: 'Do you speak English?', translation: 'Asking about language' },
            { id: 7, word: 'Where are you from?', phonetic: '/weər ɑːr juː frəm/', speakable: 'Where are you from?', translation: 'Asking about origin' },
            { id: 8, word: 'What is your favorite color?', phonetic: '/wɒt ɪz jɔːr ˈfeɪvərɪt ˈkʌlər/', speakable: 'What is your favorite color?', translation: 'Asking preference' },
            { id: 9, word: 'Can you help me?', phonetic: '/kən juː help miː/', speakable: 'Can you help me?', translation: 'Requesting assistance' },
            { id: 10, word: 'What do you do for work?', phonetic: '/wɒt duː juː duː fɔːr wɜːrk/', speakable: 'What do you do for work?', translation: 'Asking about occupation' },
        ],
        daily_conversations: [
            ...
            { id: 6, word: 'Could you please repeat that?', phonetic: '/kʊd juː pliːz rɪˈpiːt ðæt/', speakable: 'Could you please repeat that?', translation: 'Asking for clarification' },
            { id: 7, word: 'I do not understand', phonetic: '/aɪ duː nɒt ˌʌndərˈstænd/', speakable: 'I do not understand', translation: 'Expressing confusion' },
            { id: 8, word: 'Nice weather today', phonetic: '/naɪs ˈweðər təˈdeɪ/', speakable: 'Nice weather today', translation: 'Making small talk' },
            { id: 9, word: 'How is your family?', phonetic: '/haʊ ɪz jɔːr ˈfæməli/', speakable: 'How is your family?', translation: 'Asking about family' },
            { id: 10, word: 'Thank you for your help', phonetic: '/θæŋk juː fɔːr jɔːr help/', speakable: 'Thank you for your help', translation: 'Expressing gratitude' },
        ],
        expressing_feelings: [
            ...
            { id: 6, word: 'I am angry', phonetic: '/aɪ æm ˈæŋɡri/', speakable: 'I am angry', translation: 'Expressing anger' },
            { id: 7, word: 'I am sad', phonetic: '/aɪ æm sæd/', speakable: 'I am sad', translation: 'Expressing sadness' },
            { id: 8, word: 'I feel nervous', phonetic: '/aɪ fiːl ˈnɜːrvəs/', speakable: 'I feel nervous', translation: 'Expressing nervousness' },
            { id: 9, word: 'I am proud of myself', phonetic: '/aɪ æm praʊd əv maɪˈself/', speakable: 'I am proud of myself', translation: 'Expressing pride' },
            { id: 10, word: 'I am lonely', phonetic: '/aɪ æm ˈloʊnli/', speakable: 'I am lonely', translation: 'Expressing loneliness' },
        ],
        complex_sentences: [
            ...
            { id: 6, word: 'If you study hard, you will pass the exam', phonetic: '/ɪf juː ˈstʌdi hɑːrd juː wɪl pæs ðɪ ɪɡˈzæm/', speakable: 'If you study hard, you will pass the exam', translation: 'Future conditional' },
            { id: 7, word: 'She likes to read books, but he prefers to watch movies', phonetic: '/ʃiː laɪks tuː riːd bʊks bət hiː prɪˈfɜːrz tuː wɒtʃ ˈmuːviz/', speakable: 'She likes to read books, but he prefers to watch movies', translation: 'Contrast statement' },
            { id: 8, word: 'After I finished my homework, I played with my friends', phonetic: '/ˈæftər aɪ ˈfɪnɪʃt maɪ ˈhoʊmwɜːrk aɪ pleɪd wɪð maɪ frendz/', speakable: 'After I finished my homework, I played with my friends', translation: 'Sequence of events' },
            { id: 9, word: 'The student who completed the project first received a prize', phonetic: '/ðə ˈstuːdənt huː kəmˈpliːtɪd ðə ˈprɒdʒekt fɜːrst rɪˈsiːvd ə praɪz/', speakable: 'The student who completed the project first received a prize', translation: 'Relative clause with reward' },
            { id: 10, word: 'Although the weather was bad, we still had a great time', phonetic: '/ɔːlˈðoʊ ðə ˈweðər wəz bæd wiː stɪl hæd ə ɡreɪt taɪm/', speakable: 'Although the weather was bad, we still had a great time', translation: 'Concession with positive outcome' },
        ],
    },
    hindi: {
        simple_statements: [
